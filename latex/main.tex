...
These are objective financial indicators, which supports the model's fairness
profile: the model relies on creditworthiness signals rather than demographic
proxies.
